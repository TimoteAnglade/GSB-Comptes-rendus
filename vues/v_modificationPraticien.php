            ...
            <div class="test col-12 col-sm-8 col-lg-6 col-xl-5 col-xxl-4 py-lg-5 py-3">
                <form action="index.php?uc=praticien&action=" method="post" class="formulaire form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <input <?php if ($num!='') {echo 'disabled';} ?> id="num" name="num" value="<?php echo $num ; ?>" class="form-control">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" id="regcode" name="regcode" value="<?php echo $regcode ; ?>" >
                        <input id="cp" name="cp" pattern="[0-9]{3}" value="<?php echo $regcode.''.$cp ; ?>" title="Donner les trois derniers chiffres du code postal (ex: 450)" required class="form-control">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input disabled id="region" name="region" value="<?php echo $region ; ?>" class="form-control mt-3" required> 
                    </div>
                    <div class="form-group">
                        <label for="notor" class="control-label col-sm-2">Notoriété*</label>
                        <input id="notor" name="notor" type="number" value="<?php echo $notor ; ?>" required class="form-control">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="row align-items-center justify-content-center">
                        ...
                        <input class="btn btn-info text-light valider col-6 col-sm-5 col-md-4 col-lg-3" type="button" onclick="history.go(-1)" value="Retour" name="retour">
                    </div>
                </form>
            </div>
        </div>
