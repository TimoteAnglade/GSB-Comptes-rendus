        ...
        <div class="row align-items-center justify-content-center">
            ...
            <div class="test col-12 col-sm-8 col-lg-6 col-xl-5 col-xxl-4 py-lg-5 py-3">
                <div class="formulaire">
                    ...
                    <form method="POST" action="index.php?uc=praticien&action=afficherpraticien">
                                <p><span class="carac">Praticien remplaçant</span> : 
                    ...
                    foreach($offres as $med){
                        $i++;
                        ?>
                    <p><span class="carac">Echantillon offert n°<?php echo $i;?></span> : <?php echo '<a href="index.php?uc=medicaments&action=affichermedoc&medicament='.$med['med_depotlegal'].'">'.$med['med_nomcommercial'].' </a>x'.$med['off_qte']; ?></p>
                    <?php } ?>
