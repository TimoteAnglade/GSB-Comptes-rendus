                    ...
                    <h3 class="h4 pb-lg-3 text-light light-300">Information</h2>
                        <ul class="list-unstyled text-light light-300">
                            ...
                            <?php if (isset($_SESSION['login'])) {
                                ...
                                if ($_SESSION['habilitation'] == 2){
                                    echo '<li><a class="dropdown-item" href="index.php?uc=rapportdevisite&action=choisirDateMesRapports">Rapport de ma région</a></li>';
                                    echo '<li><a class="dropdown-item" href=""index.php?uc=rapportdevisite&action=historiqueFourchette">Historique des rapports</a></li>';
                                }
                                echo 
                                '</ul>
                                </li>
